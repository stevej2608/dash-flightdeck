...
# This is a html2dash clone of the dashboard-min.html
        ...
        html.Div([
            html.Div([
                ...
                html.Div([
                    ...
                    html.A([
                        html.Svg([
                            html.Path(d='M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a2 2 0 012-2h12a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4z')
                        ], className='dropdown-icon text-gray-400 me-2', fill='currentColor', viewbox='0 0 20 20', xmlns='http://www.w3.org/2000/svg'),
                        "Add Widget"
                    ], className='dropdown-item d-flex align-items-center', href='#'),
                    html.A([
                    ...
                    html.A([
                        html.Svg([
                            html.Path(fillRule='evenodd', d='M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z', clipRule='evenodd')
                        ], className='dropdown-icon text-gray-400 me-2', fill='currentColor', viewbox='0 0 20 20', xmlns='http://www.w3.org/2000/svg'),
                        "Preview Security"
                    ], className='dropdown-item d-flex align-items-center', href='#'),
                            ...
                            html.Div([
                                ...
                                html.Div([
                                    html.Div([
                                        "Since last month",
                                        html.Svg([
                                            html.Path(fillRule='evenodd', d='M14.707 12.707a1 1 0 01-1.414 0L10 9.414l-3.293 3.293a1 1 0 01-1.414-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 010 1.414z', clipRule='evenodd')
                                    ...
                                    html.Tbody([
                                        html.Tr([
                                            ...
                                            html.Td([
                                                html.Div([
                                                    html.Svg([
                                                        html.Path(fillRule='evenodd', d='M5.293 7.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L11 5.414V17a1 1 0 11-2 0V5.414L6.707 7.707a1 1 0 01-1.414 0z', clipRule='evenodd')
                                        ...
                                        html.Tr([
                                            ...
                                            html.Td([
                                                html.Div([
                                                    html.Svg([
                                                        html.Path(fillRule='evenodd', d='M14.707 12.293a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 111.414-1.414L9 14.586V3a1 1 0 012 0v11.586l2.293-2.293a1 1 0 011.414 0z', clipRule='evenodd')
                                    ...
                                    html.Li([
                                        html.Div([
                                            ...
                                            html.Div([
                                                html.A([
                                                    html.Svg([
                                                        html.Path(fillRule='evenodd', d='M18 5v8a2 2 0 01-2 2h-5l-5 4v-4H4a2 2 0 01-2-2V5a2 2 0 012-2h12a2 2 0 012 2zM7 8H5v2h2V8zm2 0h2v2H9V8zm6 0h-2v2h2V8z', clipRule='evenodd')
                                                    ], className='icon icon-xxs me-2', fill='currentColor', viewbox='0 0 20 20', xmlns='http://www.w3.org/2000/svg'),
                                                    "Message"
                                                ], href='#', className='btn btn-sm btn-secondary d-inline-flex align-items-center')
                                            ], className='col text-end')
                        ...
                        html.Div([
                            ...
                            html.Div([
                                html.Div([
                                    html.Div([
                                        html.Svg([
                                            html.Path(fillRule='evenodd', d='M3 6a3 3 0 013-3h10a1 1 0 01.8 1.6L14.25 8l2.55 3.4A1 1 0 0116 13H6a1 1 0 00-1 1v3a1 1 0 11-2 0V6z', clipRule='evenodd')
                                        ], className='icon icon-xs text-gray-500 me-2', fill='currentColor', viewbox='0 0 20 20', xmlns='http://www.w3.org/2000/svg'),
                                        "Country Rank"
                                    ], className='h6 mb-0 d-flex align-items-center'),
                                    html.Div([
                            ...
                            html.Div([
                                html.Div([
                                    html.Div([
                                        html.Svg([
                                            html.Path(fillRule='evenodd', d='M2 6a2 2 0 012-2h4l2 2h4a2 2 0 012 2v1H8a3 3 0 00-3 3v1.5a1.5 1.5 0 01-3 0V6z', clipRule='evenodd'),
                                            html.Path(d='M6 12a2 2 0 012-2h8a2 2 0 012 2v2a2 2 0 01-2 2H2h2a2 2 0 002-2v-2z')
                                        ], className='icon icon-xs text-gray-500 me-2', fill='currentColor', viewbox='0 0 20 20', xmlns='http://www.w3.org/2000/svg'),
                                        "Category Rank"
                                    ], className='h6 mb-0 d-flex align-items-center'),
                                    html.Div([
                ...
                html.Div([
                    html.Div([
                        html.Div([
                            ...
                            html.P("Tells you where your visitors originated from, such as search engines, social networks or website
                referrals."),
                            html.Div([
                                html.Div([
                                    html.Div([
                                ...
                                html.Div([
                                    html.Div([
                                        html.Svg([
                                            html.Path(d='M2 11a1 1 0 011-1h2a1 1 0 011 1v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5zM8 7a1 1 0 011-1h2a1 1 0 011 1v9a1 1 0 01-1 1H9a1 1 0 01-1-1V7zM14 4a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1h-2a1 1 0 01-1-1V4z')
                                        ], fill='currentColor', viewbox='0 0 20 20', xmlns='http://www.w3.org/2000/svg')
